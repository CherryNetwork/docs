...
### Content addressing <a href="#content-addressing" id="content-addressing"></a>
...
That jumble of letters after `/ipfs/` is called a [_content identifier_](https://docs.ipfs.io/concepts/content-addressing/) and it’s how IPFS can get content from multiple places.
...
### Participation <a href="#participation" id="participation"></a>
